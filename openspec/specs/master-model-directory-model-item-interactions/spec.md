# master-model-directory-model-item-interactions Specification

## Purpose
TBD - created by archiving change 2026-01-30-add-master-model-heatmap-and-click-copy. Update Purpose after archive.
## Requirements
