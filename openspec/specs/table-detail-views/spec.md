...
Provide detail dialogs for the account overview and model overview tables so users can inspect full datasets without cramped scrolling, while ensuring summary totals are computed from the currently filtered rows rather than the full dataset.
