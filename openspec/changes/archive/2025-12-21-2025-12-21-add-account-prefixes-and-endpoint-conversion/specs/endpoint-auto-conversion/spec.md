...
Automatically generate the corresponding Anthropic Endpoint when users input an OpenAI Endpoint (and vice versa), based on the predictable Azure resource naming pattern, reducing manual data entry while respecting user overrides.
