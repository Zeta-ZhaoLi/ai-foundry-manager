...
Enable users to document Windows login server and Linux API server credentials at the account level, providing a centralized place to track which servers are used for each Azure account's operations.
